...
if (isset($_POST['submit'])) {
    ...
    if (move_uploaded_file($_FILES["anyfile"]["tmp_name"], "uploads/" . $image_name)) {
        $sql = "INSERT INTO `blog`(`image`, `title`, `description`, `text`, `date`) VALUES ('$image_name','$title','$description','$text','$date')";
        ...
        <div id="page-wrapper" class="gray-bg dashbard-1">
                            ...
                            <form method="post" class="form-horizontal" name="myForm" onsubmit="return Validate()"
                                    ...
                                    <div class="col-sm-10">
                                        <div class="fileinput fileinput-new input-group" data-provides="fileinput">
                                            ...
                                            <span class="input-group-addon btn btn-default btn-file">
                                                ...
                                                <input type="file" name="anyfile" required>
                                            </span>
                                ...
                                <div class="form-group"><label class="col-sm-2 control-label">title</label>
                                    ...
                                    <div class="col-sm-10"><input type="text" class="form-control"
                                            placeholder=" Enter Title" id="area" name="title" required>
                                ...
                                <div class="form-group"><label class="col-sm-2 control-label">Text</label>
                                    ...
                                    <div class="col-sm-10"><input type="text" class="form-control"
                                            placeholder=" Enter text" id="area" name="text" required>
                                        <spam id="area_error" class="text-danger font-weight-bold"></spam>
                                    </div>
                                </div>
                                <div class="form-group"><label class="col-sm-2 control-label">Date</label>
                                    ...
                                    <div class="col-sm-10"><input type="date" class="form-control"
                                            placeholder=" Enter Date" id="area" name="date" required>
                                        <spam id="area_error" class="text-danger font-weight-bold"></spam>
                                    </div>
                                </div>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="ibox float-e-margins">
                        <div class="ibox-content">
                            <form method="post" action="blogupdate.php" class="form-horizontal" name="myForm"
                                onsubmit="return Validate()" enctype="multipart/form-data">
                                <div class="form-group"><label class="col-sm-2 control-label" required>title</label>

                                    <div class="col-sm-10"><input type="text" class="form-control"
                                            placeholder=" Enter Title" id="area" value="<?php echo$row['title'];?>"
                                            name="title">
                                        <spam id="area_error" class="text-danger font-weight-bold"></spam>
                                    </div>
                                </div>
                                <div class="form-group"><label class="col-sm-2 control-label">Description</label>
                                    ...
                                    <div class="col-sm-10"><textarea cols="190" name="description"
                                        ...
                                        <spam id="description_error" class="text-danger font-weight-bold">
                                        </spam>
                                    </div>
                                </div>
                                <div class="form-group"><label class="col-sm-2 control-label">Text</label>
                                    ...
                                    <div class="col-sm-10"><input type="text" class="form-control"
                                            placeholder=" Enter text" id="area" name="text" value="<?php echo$row['text'];?>" required>
                                        <spam id="area_error" class="text-danger font-weight-bold"></spam>
                                    </div>
                                </div>
                                <div class="form-group"><label class="col-sm-2 control-label">Date</label>
                                    ...
                                    <div class="col-sm-10"><input type="date" class="form-control"
                                            placeholder=" Enter Date" id="area" value="<?php echo$row['date'];?>" name="date" required>
                                        <spam id="area_error" class="text-danger font-weight-bold"></spam>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <div class="fileinput fileinput-new input-group" data-provides="fileinput">
                                            ...
                                            <span class="input-group-addon btn btn-default btn-file">
                                                <span class="fileinput-new">Select file</span>
                                                <span class="fileinput-exists">Change</span>
                                                <input type="file" name="anyfile" value="<?php echo $row['image']; ?>"
                                                    required>
                                            </span>
                                            <a href="#" class="input-group-addon btn btn-default fileinput-exists"
                                                data-dismiss="fileinput">Remove</a>
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <tr class="gradeX">
                                                                ...
                                                                <td>
                                                                    ...
                                                                    <a href="blogdelete.php?dt=<?php echo $row['id']; ?>"
