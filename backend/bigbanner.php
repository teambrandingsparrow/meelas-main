...
if (isset($_POST['submit'])) {
    ...
    if (move_uploaded_file($_FILES["anyfile"]["tmp_name"], "uploads/" . $image_name)) {
        $sql = "INSERT INTO bigbanners(image) VALUE('$image_name')";
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper" class="gray-bg dashbard-1">
            ...
            <?php
                ...
                $sql = "SELECT * FROM bigbanners where id='$edit'";
                $result = mysqli_query($conn, $sql);
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="ibox float-e-margins">
                        <div class="ibox-content">
                            <form method="post" action="bigimgupdate.php" class="form-horizontal" name="myForm"onsubmit="return Validate()" enctype="multipart/form-data">
                                                    ...
                                                    <table
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <td><?php  echo  $slno++; ?></td>
                                                                ...
                                                                <td> 
                                                                    <a href="bigbanner.php?id=<?php echo $row['id']; ?>">
                                                                            <button type="button" style="background:#5cb85c ; border-color: #4cae4c;"
                                                                        class="btn btn-success"><i
                                                                                class="fa fa-pencil-square-o"
                                                                                aria-hidden="true"></i>
                                                                    </button></a>
                                                                    <a href="bigimgdelete.php?dt=<?php echo $row['id']; ?>"onclick="return confirm('Are You Sure?')"> <button type="button" class="btn btn btn-danger"> <i class="fa fa-trash-o" aria-hidden="true"></i>
                                                                    </button></a>
                                                                </td>
                                                                <?php
                                                                }
