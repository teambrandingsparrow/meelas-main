...
$title = 'Properties | Meelas International';
?>
<!DOCTYPE html>
<html lang="en">
...
<body>
  ...
  ?>
    ...
    <section class="property-grid grid">
      ...
      $sql = "SELECT * FROM `propertiess` INNER JOIN types ON propertiess.type=types.id INNER JOIN amenities ON propertiess.id_name=amenities.store_id $Where limit $record_index,$limit";
        $Results = mysqli_query($conn, $sql);
