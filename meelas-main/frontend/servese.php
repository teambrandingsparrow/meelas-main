              ...
              <div class="agent-info-box">
                ...
                <div class="agent-content mb-3">
                  <p class="content-d color-text-a">
                    Our properties services provide end-to-end 
                    property management services that includes site visits, 
                    property photography, promoting on multiple 
                    channels, connecting with tenant and showing the 
                    property. We are mainly concentrating on Commercial 
                    Buildings, Showrooms, Godowns, office spaces, 
                    office/Residential areas, House, Villa,
                  </p>
                  <ul class="info-agents color-a">
                    ...
                    <li>We also help to maintain your warehouse or 
