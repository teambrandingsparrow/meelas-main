...
<script>
        function Validate() {
            ...
            var reg = /^\w+[a-zA-Z0-9]{5,20}$/;
            var result = reg.test(subject);
            if (result == false) {

                alert(" Please Enter Minimum Five Letters");
      ...
      <div class="row">
        <div class="col-md-12 col-lg-8">
          <div class="title-single-box">
            ...
            <span class="color-text-a"> Meela’s International – the No.1 business group with 12 years 
              ...
              Management and Interior Designing. Professional project more.</span>
          </div>
        </div>
    ...
    <div class="container">
      <div class="row">
        <div class="col-sm-12">
          <div class="contact-map box">
            <div id="map" class="contact-map">
                <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d31431.07543211187!2d76.29461180003553!3d10.026394901574129!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3b080da53444d5e9%3A0xb46c57c6b1bc9aff!2sEdappally%2C%20Kochi%2C%20Kerala!5e0!3m2!1sen!2sin!4v1655378827715!5m2!1sen!2sin"
        ...
        <div class="col-sm-12 section-t8">
          <div class="row">
            <div class="col-md-7">
              <form class="form-a" action="" method="post" role="form" name="myForm" onsubmit="return Validate()">
