...
$Where = "";
$title = 'Rent | Meelas International';
...
<body>
  ...
  ?>
    ...
    <section class="property-grid grid">
      ...
      $sql = "SELECT * FROM `propertiess` INNER JOIN types ON propertiess.type=types.id INNER JOIN amenities ON propertiess.id_name=amenities.store_id where type=3$Where limit $record_index,$limit";
        $Results = mysqli_query($conn, $sql);
                        ...
                        <nav class="pagination-a">
                            <ul class="pagination justify-content-end">
                                ...
                                <li class="page-item prevuios">
                                    <a class="page-link" href="rent.php?page=<?php echo $page-1?>">
                                ...
                                <li class="page-item">
                                    <a class="page-link" href="rent.php?page=<?php echo $i ?>"><?php echo $i;?></a>
                                </li>
                                <?php
                                        }
?>
