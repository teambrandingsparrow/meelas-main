...
// $pagi = "SELECT * FROM `propertiess` " . $whr . " limit $record_index,$limit";
...
<body>
  ...
  ?>
    ...
    <section class="property-grid grid">
        ...
        echo   $sql = "SELECT * FROM `propertiess` INNER JOIN types ON propertiess.type=types.id INNER JOIN amenities ON propertiess.propertyid=amenities.id_amen $Where limit $record_index,$limit";
        $Results = mysqli_query($conn, $sql);
                        ...
                        <nav class="pagination-a">
                            <ul class="pagination justify-content-end">
                                ...
                                <li class="page-item disabled">
                                    <a class="page-link" href="property-grid.php?page=<?php echo $page-1?>">
                                        <span class="ion-ios-arrow-back"></span>Pre
                                    </a>
                                </li>
                                <?php
                                ...
                                <li class="page-item">
                                    <a class="page-link"
                                        href="property-grid.php?page=<?php echo $i ?>"><?php echo $i;?></a>
                                </li>
                                <?php
                                        }
?>
                                ...
                                <li class="page-item next">
                                    <a class="page-link" href="property-grid.php?page=<?php echo $page+1?>">
                                        <span class="ion-ios-arrow-forward"></span>Next
                                    </a>
                                    <?php } ?>
                                </li>
