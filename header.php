    ...
    <div class="container">
        ...
        <div class="navbar-collapse collapse justify-content-center" id="navbarDefault">
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="property-grid.php">Sale</a>
                </li>
                <li class="nav-item">
...
<section class="topbarsectin">
    <div class="searchsection">
        ...
        <div class="tabs">
            <ul>
                <li><a class="nav-link active" href="buy.php">Sale</a></li>
                <li><a class="nav-link" href="rent.php">Rent</a></li>
                <li><a class="nav-link" href="pg.php">PG</a></li>
                <li><a class="nav-link" href="plot.php">Plot</a></li>
                <!-- <li><a class="nav-link" href="#!">Post Free Property Ad </a></li> -->
            </ul>
        </div>
        <form class="searchbar" method="post"action="property-grid.php">
            <div class="select">
                <i class="fa fa-home" aria-hidden="true"></i>
